...
<div class="panel panel-<?php echo emd_get_attr_val('campus_directory', $post->ID, 'emd_person', 'emd_person_type', 'key'); ?>">
    <div class="panel-heading">
        <div class="panel-title"> <span class='single-title font-bold'> <?php echo esc_html(emd_mb_meta('emd_person_fname')); ?>
            ...
            <div class="row">
                <div class="col-sm-4 <?php echo ((wp_get_attachment_url(current(get_post_meta(get_the_ID() , 'emd_person_photo')))) ? "well-left" : "well-left hidden"); ?>">
                    <div class="slcontent emdbox">
                        ...
                        <div class="img-gallery segment-block ent-person-photo"> <a href="<?php echo get_permalink(); ?>" title="<?php echo get_the_title(); ?>"><?php if (get_post_meta($post->ID, 'emd_person_photo')) {
		...
		echo '<img class="emd-img thumb" src="' . $thumb[0] . '" width="' . $thumb[1] . '" height="' . $thumb[2] . '" alt="' . get_post_meta($sval[0], '_wp_attachment_image_alt', true) . '"/>';
                ...
                <div class="col-sm-<?php echo ((wp_get_attachment_url(current(get_post_meta(get_the_ID() , 'emd_person_photo')))) ? "8" : "12"); ?>">
                    <div class="srcontent emdbox">
                        ...
                        <div class="single-content segment-block ent-person-type"> <?php echo emd_get_attr_val('campus_directory', $post->ID, 'emd_person', 'emd_person_type'); ?> </div>
                        <?php
} ?><?php if (emd_is_item_visible('tax_person_title', 'campus_directory', 'taxonomy')) { ?> 
                        <div class="single-content segment-block tax-person-title"> <?php echo emd_get_tax_vals(get_the_ID() , 'person_title'); ?> </div>
                        <?php
} ?><?php if (emd_is_item_visible('ent_person_office', 'campus_directory', 'attribute')) { ?> 
                        <div class="single-content segment-block ent-person-office"> <span class="dashicons dashicons-building"></span> <?php echo esc_html(emd_mb_meta('emd_person_office')); ?>
 </div>
                        <?php
} ?><?php if (emd_is_item_visible('ent_person_phone', 'campus_directory', 'attribute')) { ?> 
                        <div class="single-content segment-block ent-person-phone"> <span class="dashicons dashicons-phone"></span> <a href="tel:<?php echo esc_html(emd_mb_meta('emd_person_phone')); ?>
"><?php echo esc_html(emd_mb_meta('emd_person_phone')); ?>
</a> </div>
                        <?php
} ?><?php if (emd_is_item_visible('ent_person_email', 'campus_directory', 'attribute')) { ?> 
                        <div class="single-content segment-block ent-person-email"> <span class="dashicons dashicons-email-alt"></span> <a href="mailto:<?php echo antispambot(esc_html(emd_mb_meta('emd_person_email'))); ?>"><?php echo antispambot(esc_html(emd_mb_meta('emd_person_email'))); ?></a> </div>
                        <?php
} ?> 
                    </div>
                </div>
        ...
        <div class=" contact-links clearfix">
            <div class="social" style="margin:15px 0">
                <?php if (emd_is_item_visible('ent_person_linkedin', 'campusdir_pro', 'attribute')) { ?>
                <div>
                    <a class="social-icon linkedin animate" href="<?php echo esc_html(emd_mb_meta('emd_person_linkedin')); ?>
"><i class="fa fa-linkedin fa-fw" style="font-size:20px"></i></a>
                </div>
                <?php
} ?> <?php if (emd_is_item_visible('ent_person_twitter', 'campusdir_pro', 'attribute')) { ?>
                <div>
                    <a class="social-icon twitter animate" href="<?php echo esc_html(emd_mb_meta('emd_person_twitter')); ?>
"><i class="fa fa-twitter fa-fw" style="font-size:20px"></i></a>
        ...
        <div class="tab-container wpastabcontainer" style="padding:0 20px 40px">
            <ul class="nav nav-tabs" role="tablist" style="padding-bottom: 0px">
                <li class=" active"> <a data-toggle="tab" href="#bio" id="bio-tablink" role="tab"><?php _e('Bio', 'campus-directory'); ?></a> </li>
                <li> <a data-toggle="tab" href="#background" id="background-tablink" role="tab"><?php _e('Background', 'campus-directory'); ?></a> </li>
                <li> <a data-toggle="tab" href="#details" id="details-tablink" role="tab"><?php _e('Details', 'campus-directory'); ?></a> </li>
            </ul>
            <div class="tab-content wpastabcontent">
                <div class="tab-pane fade in active" id="bio">
                    <?php if (emd_is_item_visible('ent_person_bio', 'campus_directory', 'attribute')) { ?> 
                    <div class="single-content ent-person-bio"> <?php echo emd_mb_meta('emd_person_bio'); ?>
 </div>
                    <?php
} ?> 
                </div>
                <div class="tab-pane fade in" id="background">
                    ...
                    <div class="segment-block tax-person-rareas">
                        <div class="row" data-has-attrib="false">
                            <div class="col-sm-4"> <span class="segtitle"><?php _e('Research Area', 'campus-directory'); ?></span> </div>
                            <div class="col-sm-8"> <span class="segvalue"><?php echo emd_get_tax_vals(get_the_ID() , 'person_rareas'); ?></span> </div>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="segment-block ent-person-cv">
                        <div class="row" data-has-attrib="false">
                            <div class="col-sm-4"> <span class="segtitle"><?php _e('Curriculum Vitae', 'campus-directory'); ?></span> </div>
                            <div class="col-sm-8"> <span class="segvalue"><?php
...
?>
                    ...
                    <div class="segment-block tax-person-area">
                        <div class="row" data-has-attrib="false">
                            <div class="col-sm-4"> <span class="segtitle"><?php _e('Academic Area', 'campus-directory'); ?></span> </div>
                            <div class="col-sm-8"> <span class="segvalue"><?php echo emd_get_tax_vals(get_the_ID() , 'person_area'); ?></span> </div>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="segment-block ent-person-education">
                        <div class="row" data-has-attrib="false">
                            <div class="col-sm-4"> <span class="segtitle"><?php _e('Education', 'campus-directory'); ?></span> </div>
                            <div class="col-sm-8"> <span class="segvalue"><?php echo emd_mb_meta('emd_person_education'); ?>
</span> </div>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="segment-block ent-person-awards">
                        <div class="row" data-has-attrib="false">
                            <div class="col-sm-4"> <span class="segtitle"><?php _e('Awards and Honors', 'campus-directory'); ?></span> </div>
                            <div class="col-sm-8"> <span class="segvalue"><?php echo emd_mb_meta('emd_person_awards'); ?>
</span> </div>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="segment-block ent-person-appointments">
                        <div class="row" data-has-attrib="false">
                            <div class="col-sm-4"> <span class="segtitle"><?php _e('Academic Appointments', 'campus-directory'); ?></span> </div>
                            <div class="col-sm-8"> <span class="segvalue"><?php echo emd_mb_meta('emd_person_appointments'); ?>
</span> </div>
                        </div>
                    </div>
                    <?php
                ...
                <div class="tab-pane fade in" id="details">
                    ...
                    <div class="segment-block tax-person-location">
                        <div class="row" data-has-attrib="false">
                            <div class="col-sm-4"> <span class="segtitle"><?php _e('Location', 'campus-directory'); ?></span> </div>
                            <div class="col-sm-8"> <span class="segvalue"><?php echo emd_get_tax_vals(get_the_ID() , 'person_location'); ?></span> </div>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="segment-block ent-person-address">
                        <div class="row" data-has-attrib="false">
                            <div class="col-sm-4"> <span class="segtitle"><?php _e('Address', 'campus-directory'); ?></span> </div>
                            <div class="col-sm-8"> <span class="segvalue"><?php echo esc_html(emd_mb_meta('emd_person_address')); ?>
</span> </div>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="segment-block ent-person-website">
                        <div class="row" data-has-attrib="false">
                            <div class="col-sm-4"> <span class="segtitle"><?php _e('Website', 'campus-directory'); ?></span> </div>
                            <div class="col-sm-8">
...
' target='_blank' title='<?php echo get_the_title(); ?>'><?php _e('Click for more info', 'campus-directory'); ?></a></span>
                    ...
                    <div class="segment-block ent-person-pwebsite">
                        <div class="row" data-has-attrib="false">
                            <div class="col-sm-4"> <span class="segtitle"><?php _e('Personal Website', 'campus-directory'); ?></span> </div>
                            <div class="col-sm-8">
...
foreach ($cust_fields as $ckey => $cval) {
	if (empty($ent_attrs['emd_person'][$ckey]) && !preg_match('/^(_|wpas_|emd_)/', $ckey)) {
		$cust_key = str_replace('-', '_', sanitize_title($ckey));
		if (empty($ent_map_list) || (!empty($ent_map_list) && empty($ent_map_list['emd_person']['cust_fields'][$cust_key]))) {
...
?><div id='cust-field-<?php echo $fcount; ?>'> 
                    <div class="segment-block emd-person-custom-fields">
                        <div class="row">
                            <div class="col-sm-4"> <span class="segtitle"><?php echo $rkey; ?></span> </div>
                            <div class="col-sm-8"> <span class="segvalue"><?php echo $val; ?></span> </div>
                        </div>
                    </div>
                    </div><?php
	}
...
?> 
        ...
        <div class="contact-links" id="emd-accordion"> <?php if (emd_is_item_visible('entrelcon_from_support_staff', 'campus_directory', 'relation')) { ?>
<?php $post = get_post();
	$rel_filter = "";
...
<?php
    ...
    <div class="panel-footer">
        ...
        <div class="footer-segment-block"> <span class="footer-object-title label label-info" style="margin-right:2px"><?php _e('Directory Tag', 'campus-directory'); ?></span><span class="footer-object-value"><?php echo emd_get_tax_vals(get_the_ID() , 'directory_tag'); ?></span> </div>
        <?php
} ?> 
    </div>
</div>
