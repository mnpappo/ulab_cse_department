...
b)-1)+c},easeOutCirc:function(a,b,c,d,e){return d*Math.sqrt(1-(b=b/e-1)*b)+c},easeInOutCirc:function(a,b,c,d,e){return 1>(b/=e/2)?-d/2*(Math.sqrt(1-b*b)-1)+c:d/2*(Math.sqrt(1-(b-=2)*b)+1)+c},easeInElastic:function(a,b,c,d,e){a=1.70158;var g=0,l=d;if(0==b)return c;if(1==(b/=e))return c+d;g||(g=.3*e);l<Math.abs(d)?(l=d,a=g/4):a=g/(2*Math.PI)*Math.asin(d/l);return-(l*Math.pow(2,10*--b)*Math.sin(2*(b*e-a)*Math.PI/g))+c},easeOutElastic:function(a,b,c,d,e){a=1.70158;var g=0,l=d;if(0==b)return c;if(1==(b/=
e))return c+d;g||(g=.3*e);l<Math.abs(d)?(l=d,a=g/4):a=g/(2*Math.PI)*Math.asin(d/l);return l*Math.pow(2,-10*b)*Math.sin(2*(b*e-a)*Math.PI/g)+d+c},easeInOutElastic:function(a,b,c,d,e){a=1.70158;var g=0,l=d;if(0==b)return c;if(2==(b/=e/2))return c+d;g||(g=.3*e*1.5);l<Math.abs(d)?(l=d,a=g/4):a=g/(2*Math.PI)*Math.asin(d/l);return 1>b?-.5*l*Math.pow(2,10*--b)*Math.sin(2*(b*e-a)*Math.PI/g)+c:.5*l*Math.pow(2,-10*--b)*Math.sin(2*(b*e-a)*Math.PI/g)+d+c},easeInBack:function(a,b,c,d,e,g){void 0==g&&(g=1.70158);
...
(function(a){a.fn.supersubs=function(b){var c=a.extend({},a.fn.supersubs.defaults,b);return this.each(function(){var b=a(this),e=a.meta?a.extend({},c,b.data()):c,g=b.find("ul").show(),l=a('<li id="menu-fontsize">&#8212;</li>').css({padding:0,position:"absolute",top:"-999em",width:"auto"}).appendTo(b)[0].clientWidth;a("#menu-fontsize").remove();g.each(function(b){b=a(this);var c=b.children(),d=c.children("a"),g=c.css("white-space","nowrap").css("float");b.add(c).add(d).css({"float":"none",width:"auto"});
d=b[0].clientWidth/l;d+=e.extraWidth;d>e.maxWidth?d=e.maxWidth:d<e.minWidth&&(d=e.minWidth);b.css("width",d+"em");c.css({"float":g,width:"100%","white-space":"normal"}).each(function(){var b=a(this).children("ul"),c=void 0!==b.css("left")?"left":"right";b.css(c,"100%")})}).hide()})};a.fn.supersubs.defaults={minWidth:9,maxWidth:25,extraWidth:0}})(jQuery);
(function(a){var b=0,c=0,d=0,e=0,g="ontouchstart"in window||0<navigator.msMaxTouchPoints,l="onorientationchange"in window,f=!1,n=!1,w=!1,D=!1,p=!1,u="pointer",z="pointer",V=[],R=[],la=[],X=[],J=[],aa=[],K=[],q=[],C=[],ba=[],ga=[],m={showScrollbar:function(b,c){b.scrollbarHide&&a("."+c).css({opacity:b.scrollbarOpacity,filter:"alpha(opacity:"+100*b.scrollbarOpacity+")"})},hideScrollbar:function(a,b,c,d,e,h,g,f,l,n){if(a.scrollbar&&a.scrollbarHide)for(var k=c;k<c+25;k++)b[b.length]=m.hideScrollbarIntervalTimer(10*
k,d[c],(c+24-k)/24,e,h,g,f,l,n,a)},hideScrollbarInterval:function(b,c,k,d,g,h,f,l,n){e=-1*b/C[l]*(g-h-f-d);m.setSliderOffset("."+k,e);a("."+k).css({opacity:n.scrollbarOpacity*c,filter:"alpha(opacity:"+n.scrollbarOpacity*c*100+")"})},slowScrollHorizontalInterval:function(b,c,k,d,g,h,f,l,n,w,t,L,z,P,E,y,p,r,F){if(F.infiniteSlider){if(k<=-1*C[y]){var x=a(b).width();if(k<=-1*ba[y]){var A=-1*t[0];a(c).each(function(b){m.setSliderOffset(a(c)[b],A+p);b<L.length&&(L[b]=-1*A);A+=E[b]});k+=-1*L[0];q[y]=-1*
L[0]+p;C[y]=q[y]+x-h;K[y]=0}else{var B=0,N=m.getSliderOffset(a(c[0]),"x");a(c).each(function(a){m.getSliderOffset(this,"x")<N&&(N=m.getSliderOffset(this,"x"),B=a)});z=q[y]+x;m.setSliderOffset(a(c)[B],z);q[y]=-1*L[1]+p;C[y]=q[y]+x-h;L.splice(0,1);L.splice(L.length,0,-1*z+p);K[y]++}}if(k>=-1*q[y]||0<=k){x=a(b).width();if(0<k)for(A=-1*t[0],a(c).each(function(b){m.setSliderOffset(a(c)[b],A+p);b<L.length&&(L[b]=-1*A);A+=E[b]}),k-=-1*L[0],q[y]=-1*L[0]+p,C[y]=q[y]+x-h,K[y]=P;0<-1*L[0]-x+p;){var Q=0,O=m.getSliderOffset(a(c[0]),
"x");a(c).each(function(a){m.getSliderOffset(this,"x")>O&&(O=m.getSliderOffset(this,"x"),Q=a)});z=q[y]-E[Q];m.setSliderOffset(a(c)[Q],z);L.splice(0,0,-1*z+p);L.splice(L.length-1,1);q[y]=-1*L[0]+p;C[y]=q[y]+x-h;K[y]--;J[y]++}0>k&&(Q=0,O=m.getSliderOffset(a(c[0]),"x"),a(c).each(function(a){m.getSliderOffset(this,"x")>O&&(O=m.getSliderOffset(this,"x"),Q=a)}),z=q[y]-E[Q],m.setSliderOffset(a(c)[Q],z),L.splice(0,0,-1*z+p),L.splice(L.length-1,1),q[y]=-1*L[0]+p,C[y]=q[y]+x-h,K[y]--)}}t=!1;h=m.calcActiveOffset(F,
k,L,h,K[y],P,w,y);z=(h+K[y]+P)%P;F.infiniteSlider?z!=aa[y]&&(t=!0):h!=J[y]&&(t=!0);if(t&&(P=new m.args("change",F,b,a(b).children(":eq("+z+")"),z,r),a(b).parent().data("args",P),""!=F.onSlideChange))F.onSlideChange(P);J[y]=h;aa[y]=z;k=Math.floor(k);m.setSliderOffset(b,k);F.scrollbar&&(e=Math.floor((-1*k-q[y]+p)/(C[y]-q[y]+p)*(f-l-g)),b=g-n,k>=-1*q[y]+p?(b=g-n- -1*e,m.setSliderOffset(a("."+d),0)):(k<=-1*C[y]+1&&(b=f-l-n-e),m.setSliderOffset(a("."+d),e)),a("."+d).css({width:b+"px"}))},slowScrollHorizontal:function(b,
c,k,d,e,h,g,f,l,n,w,z,p,P,E,y,D,r,F,G,u){var x=m.getSliderOffset(b,"x");h=[];var B=0,A=25/1024*f;frictionCoefficient=u.frictionCoefficient;elasticFrictionCoefficient=u.elasticFrictionCoefficient;snapFrictionCoefficient=u.snapFrictionCoefficient;e>u.snapVelocityThreshold&&u.snapToChildren&&!F?B=1:e<-1*u.snapVelocityThreshold&&u.snapToChildren&&!F&&(B=-1);e<-1*A?e=-1*A:e>A&&(e=A);a(b)[0]!==a(r)[0]&&(B*=-1,e*=-2);r=K[E];if(u.infiniteSlider)var N=q[E],Q=C[E];F=[];for(var A=[],t=0;t<p.length;t++)F[t]=
p[t],t<c.length&&(A[t]=m.getSliderOffset(a(c[t]),"x"));for(;1<e||-1>e;){e*=frictionCoefficient;x+=e;(x>-1*q[E]||x<-1*C[E])&&!u.infiniteSlider&&(e*=elasticFrictionCoefficient,x+=e);if(u.infiniteSlider){if(x<=-1*Q){for(var Q=a(b).width(),O=0,L=A[0],t=0;t<A.length;t++)A[t]<L&&(L=A[t],O=t);t=N+Q;A[O]=t;N=-1*F[1]+G;Q=N+Q-f;F.splice(0,1);F.splice(F.length,0,-1*t+G);r++}if(x>=-1*N){Q=a(b).width();O=0;L=A[0];for(t=0;t<A.length;t++)A[t]>L&&(L=A[t],O=t);t=N-P[O];A[O]=t;F.splice(0,0,-1*t+G);F.splice(F.length-
1,1);N=-1*F[0]+G;Q=N+Q-f;r--}}h[h.length]=x}A=!1;e=m.calcActiveOffset(u,x,F,f,r,D,J[E],E);u.snapToChildren&&(u.infiniteSlider?(e+r+D)%D!=aa[E]&&(A=!0):e!=J[E]&&(A=!0),0>B&&!A?(e++,e>=p.length&&!u.infiniteSlider&&(e=p.length-1)):0<B&&!A&&(e--,0>e&&!u.infiniteSlider&&(e=0)));if(u.snapToChildren||(x>-1*q[E]||x<-1*C[E])&&!u.infiniteSlider){for((x>-1*q[E]||x<-1*C[E])&&!u.infiniteSlider?h.splice(0,h.length):(h.splice(.1*h.length,h.length),x=0<h.length?h[h.length-1]:x);x<F[e]-.5||x>F[e]+.5;)x=(x-F[e])*snapFrictionCoefficient+
F[e],h[h.length]=x;h[h.length]=F[e]}B=1;0!=h.length%2&&(B=0);for(x=0;x<k.length;x++)clearTimeout(k[x]);r=(e+r+D)%D;N=0;for(x=B;x<h.length;x+=2)if(x==B||1<Math.abs(h[x]-N)||x>=h.length-2)N=h[x],k[k.length]=m.slowScrollHorizontalIntervalTimer(10*x,b,c,h[x],d,g,f,l,n,w,e,z,p,y,D,P,E,G,r,u);N=(e+K[E]+D)%D;""!=u.onSlideComplete&&1<h.length&&(k[k.length]=m.onSlideCompleteTimer(10*(x+1),u,b,a(b).children(":eq("+N+")"),r,E));X[E]=k;m.hideScrollbar(u,k,x,h,d,g,f,n,w,E)},onSlideComplete:function(b,c,k,d,e){k=
new m.args("complete",b,a(c),k,d,d);a(c).parent().data("args",k);if(""!=b.onSlideComplete)b.onSlideComplete(k)},getSliderOffset:function(b,c){var k;c="x"==c?4:5;if(!f||n||w)k=parseInt(a(b).css("left"),10);else{k=["-webkit-transform","-moz-transform","transform"];for(var d,e=0;e<k.length;e++)if(void 0!=a(b).css(k[e])&&0<a(b).css(k[e]).length){d=a(b).css(k[e]).split(",");break}k=void 0==d[c]?0:parseInt(d[c],10)}return k},setSliderOffset:function(b,c){c=parseInt(c,10);!f||n||w?a(b).css({left:c+"px"}):
a(b).css({msTransform:"matrix(1,0,0,1,"+c+",0)",webkitTransform:"matrix(1,0,0,1,"+c+",0)",MozTransform:"matrix(1,0,0,1,"+c+",0)",transform:"matrix(1,0,0,1,"+c+",0)"})},setBrowserInfo:function(){null!=navigator.userAgent.match("WebKit")?(u="-webkit-grab",z="-webkit-grabbing"):null!=navigator.userAgent.match("Gecko")?(p=!0,u="move",z="-moz-grabbing"):null!=navigator.userAgent.match("MSIE 7")?D=n=!0:null!=navigator.userAgent.match("MSIE 8")?D=w=!0:null!=navigator.userAgent.match("MSIE 9")&&(D=!0)},has3DTransform:function(){var b=
!1,c=a("<div />").css({msTransform:"matrix(1,1,1,1,1,1)",webkitTransform:"matrix(1,1,1,1,1,1)",MozTransform:"matrix(1,1,1,1,1,1)",transform:"matrix(1,1,1,1,1,1)"});""==c.attr("style")?b=!1:p&&21<=parseInt(navigator.userAgent.split("/")[3],10)?b=!1:void 0!=c.attr("style")&&(b=!0);return b},getSlideNumber:function(a,b,c){return(a-K[b]+c)%c},calcActiveOffset:function(a,b,c,d,e,g,f,l){e=!1;a=[];var k;b>c[0]&&(k=0);b<c[c.length-1]&&(k=g-1);for(g=0;g<c.length;g++)c[g]<=b&&c[g]>b-d&&(e||c[g]==b||(a[a.length]=
c[g-1]),a[a.length]=c[g],e=!0);0==a.length&&(a[0]=c[c.length-1]);for(g=e=0;g<a.length;g++)f=Math.abs(b-a[g]),f<d&&(e=a[g],d=f);for(g=0;g<c.length;g++)e==c[g]&&(k=g);return k},changeSlide:function(b,c,k,d,e,g,f,l,n,w,t,p,z,u,q,y,D,r){m.autoSlidePause(u);for(var h=0;h<d.length;h++)clearTimeout(d[h]);var x=Math.ceil(r.autoSlideTransTimer/10)+1,A=m.getSliderOffset(c,"x"),B=p[b],Q=B-A;if(r.infiniteSlider)for(b=(b-K[u]+2*y)%y,h=!1,0==b&&2==y&&(b=y,p[b]=p[b-1]-a(k).eq(0).outerWidth(!0),h=!0),B=p[b],Q=B-
A,B=[p[b]-a(c).width(),p[b]+a(c).width()],h&&p.splice(p.length-1,1),h=0;h<B.length;h++)Math.abs(B[h]-A)<Math.abs(Q)&&(Q=B[h]-A);var B=[],N;m.showScrollbar(r,e);for(h=0;h<=x;h++)N=h,N/=x,N--,N=A+Q*(Math.pow(N,5)+1),B[B.length]=N;x=(b+K[u]+y)%y;for(h=A=0;h<B.length;h++){if(0==h||1<Math.abs(B[h]-A)||h>=B.length-2)A=B[h],d[h]=m.slowScrollHorizontalIntervalTimer(10*(h+1),c,k,B[h],e,g,f,l,n,w,b,t,p,q,y,z,u,D,x,r);0==h&&""!=r.onSlideStart&&(Q=(J[u]+K[u]+y)%y,r.onSlideStart(new m.args("start",r,c,a(c).children(":eq("+
Q+")"),Q,b)))}A=!1;r.infiniteSlider?x!=aa[u]&&(A=!0):b!=J[u]&&(A=!0);A&&""!=r.onSlideComplete&&(d[d.length]=m.onSlideCompleteTimer(10*(h+1),r,c,a(c).children(":eq("+x+")"),x,u));X[u]=d;m.hideScrollbar(r,d,h,B,e,g,f,n,w,u);m.autoSlide(c,k,d,e,g,f,l,n,w,t,p,z,u,q,y,D,r)},autoSlide:function(a,b,c,d,e,g,f,l,n,w,t,p,u,z,q,y,D){if(!R[u].autoSlide)return!1;m.autoSlidePause(u);V[u]=setTimeout(function(){!D.infiniteSlider&&J[u]>t.length-1&&(J[u]-=q);m.changeSlide((J[u]+K[u]+t.length+1)%t.length,a,b,c,d,e,
g,f,l,n,w,t,p,u,z,q,y,D);m.autoSlide(a,b,c,d,e,g,f,l,n,w,t,p,u,z,q,y,D)},D.autoSlideTimer+D.autoSlideTransTimer)},autoSlidePause:function(a){clearTimeout(V[a])},isUnselectable:function(b,c){return""!=c.unselectableSelector&&1==a(b).closest(c.unselectableSelector).length?!0:!1},slowScrollHorizontalIntervalTimer:function(a,b,c,d,e,g,f,l,n,w,u,p,z,q,D,y,C,r,F,G){return setTimeout(function(){m.slowScrollHorizontalInterval(b,c,d,e,g,f,l,n,w,u,p,z,q,D,y,C,r,F,G)},a)},onSlideCompleteTimer:function(a,b,c,
d,e,g){return setTimeout(function(){m.onSlideComplete(b,c,d,e,g)},a)},hideScrollbarIntervalTimer:function(a,b,c,d,e,g,f,l,n,w){return setTimeout(function(){m.hideScrollbarInterval(b,c,d,e,g,f,l,n,w)},a)},args:function(b,c,d,e,g,f){this.prevSlideNumber=void 0==a(d).parent().data("args")?void 0:a(d).parent().data("args").prevSlideNumber;this.prevSlideObject=void 0==a(d).parent().data("args")?void 0:a(d).parent().data("args").prevSlideObject;this.targetSlideNumber=f+1;this.targetSlideObject=a(d).children(":eq("+
f+")");this.slideChanged=!1;"load"==b?this.targetSlideObject=this.targetSlideNumber=void 0:"start"==b?this.targetSlideObject=this.targetSlideNumber=void 0:"change"==b?(this.slideChanged=!0,this.prevSlideNumber=void 0==a(d).parent().data("args")?c.startAtSlide:a(d).parent().data("args").currentSlideNumber,this.prevSlideObject=a(d).children(":eq("+this.prevSlideNumber+")")):"complete"==b&&(this.slideChanged=a(d).parent().data("args").slideChanged);this.settings=c;this.data=a(d).parent().data("iosslider");
this.sliderObject=d;this.sliderContainerObject=a(d).parent();this.currentSlideObject=e;this.currentSlideNumber=g+1;this.currentSliderOffset=-1*m.getSliderOffset(d,"x")},preventDrag:function(a){a.preventDefault()},preventClick:function(a){a.stopImmediatePropagation();return!1},enableClick:function(){return!0}};m.setBrowserInfo();var Y={init:function(B,p){f=m.has3DTransform();var k=a.extend(!0,{elasticPullResistance:.6,frictionCoefficient:.92,elasticFrictionCoefficient:.6,snapFrictionCoefficient:.92,
snapToChildren:!1,snapSlideCenter:!1,startAtSlide:1,scrollbar:!1,scrollbarDrag:!1,scrollbarHide:!0,scrollbarLocation:"top",scrollbarContainer:"",scrollbarOpacity:.4,scrollbarHeight:"4px",scrollbarBorder:"0",scrollbarMargin:"5px",scrollbarBackground:"#000",scrollbarBorderRadius:"100px",scrollbarShadow:"0 0 0 #000",scrollbarElasticPullResistance:.9,desktopClickDrag:!1,keyboardControls:!1,tabToAdvance:!1,responsiveSlideContainer:!0,responsiveSlides:!0,navSlideSelector:"",navPrevSelector:"",navNextSelector:"",
autoSlideToggleSelector:"",autoSlide:!1,autoSlideTimer:5E3,autoSlideTransTimer:750,autoSlideHoverPause:!0,infiniteSlider:!1,snapVelocityThreshold:5,slideStartVelocityThreshold:0,horizontalSlideLockThreshold:5,verticalSlideLockThreshold:3,stageCSS:{position:"relative",top:"0",left:"0",overflow:"hidden",zIndex:1},unselectableSelector:"",onSliderLoaded:"",onSliderUpdate:"",onSliderResize:"",onSlideStart:"",onSlideChange:"",onSlideComplete:""},B);void 0==p&&(p=this);return a(p).each(function(f){function x(){m.autoSlidePause(h);
xa=a(H).find("a");Ca=a(H).find("[onclick]");ra=a(H).find("*");a(F).css("width","");a(F).css("height","");a(H).css("width","");I=a(H).children().not("script").get();ja=[];S=[];k.responsiveSlides&&a(I).css("width","");C[h]=0;v=[];y=a(F).parent().width();G=a(F).outerWidth(!0);k.responsiveSlideContainer&&(G=a(F).outerWidth(!0)>y?y:a(F).width());a(F).css({position:k.stageCSS.position,top:k.stageCSS.top,left:k.stageCSS.left,overflow:k.stageCSS.overflow,zIndex:k.stageCSS.zIndex,webkitPerspective:1E3,webkitBackfaceVisibility:"hidden",
msTouchAction:"pan-y",width:G});a(k.unselectableSelector).css({cursor:"default"});for(var b=0;b<I.length;b++){ja[b]=a(I[b]).width();S[b]=a(I[b]).outerWidth(!0);var c=S[b];k.responsiveSlides&&(S[b]>G?(c=G+-1*(S[b]-ja[b]),ja[b]=c,S[b]=G):c=ja[b],a(I[b]).css({width:c}));a(I[b]).css({webkitBackfaceVisibility:"hidden",overflow:"hidden",position:"absolute"});v[b]=-1*C[h];C[h]=C[h]+c+(S[b]-ja[b])}k.snapSlideCenter&&(r=.5*(G-S[0]),k.responsiveSlides&&S[0]>G&&(r=0));ba[h]=2*C[h];for(b=0;b<I.length;b++)m.setSliderOffset(a(I[b]),
-1*v[b]+C[h]+r),v[b]-=C[h];if(!k.infiniteSlider&&!k.snapSlideCenter){for(b=0;b<v.length&&!(v[b]<=-1*(2*C[h]-G));b++)Da=b;v.splice(Da+1,v.length);v[v.length]=-1*(2*C[h]-G)}for(b=0;b<v.length;b++)W[b]=v[b];va&&(R[h].startAtSlide=R[h].startAtSlide>v.length?v.length:R[h].startAtSlide,k.infiniteSlider?(R[h].startAtSlide=(R[h].startAtSlide-1+M)%M,J[h]=R[h].startAtSlide):(R[h].startAtSlide=0>R[h].startAtSlide-1?v.length-1:R[h].startAtSlide,J[h]=R[h].startAtSlide-1),aa[h]=J[h]);q[h]=C[h]+r;a(H).css({position:"relative",
cursor:u,webkitPerspective:"0",webkitBackfaceVisibility:"hidden",width:C[h]+"px"});da=C[h];C[h]=2*C[h]-G+2*r;(ea=da+r<G||0==G?!0:!1)&&a(H).css({cursor:"default"});Y=a(F).parent().outerHeight(!0);ma=a(F).height();k.responsiveSlideContainer&&(ma=ma>Y?Y:ma);a(F).css({height:ma});m.setSliderOffset(H,v[J[h]]);if(k.infiniteSlider&&!ea){b=m.getSliderOffset(a(H),"x");for(c=(K[h]+M)%M*-1;0>c;){var d=0,e=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")<e&&(e=m.getSliderOffset(this,
"x"),d=a)});var g=q[h]+da;m.setSliderOffset(a(I)[d],g);q[h]=-1*v[1]+r;C[h]=q[h]+da-G;v.splice(0,1);v.splice(v.length,0,-1*g+r);c++}for(;0<-1*v[0]-da+r&&k.snapSlideCenter&&va;){var f=0,x=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")>x&&(x=m.getSliderOffset(this,"x"),f=a)});g=q[h]-S[f];m.setSliderOffset(a(I)[f],g);v.splice(0,0,-1*g+r);v.splice(v.length-1,1);q[h]=-1*v[0]+r;C[h]=q[h]+da-G;K[h]--;J[h]++}for(;b<=-1*C[h];)d=0,e=m.getSliderOffset(a(I[0]),"x"),a(I).each(function(a){m.getSliderOffset(this,
"x")<e&&(e=m.getSliderOffset(this,"x"),d=a)}),g=q[h]+da,m.setSliderOffset(a(I)[d],g),q[h]=-1*v[1]+r,C[h]=q[h]+da-G,v.splice(0,1),v.splice(v.length,0,-1*g+r),K[h]++,J[h]--}m.setSliderOffset(H,v[J[h]]);k.desktopClickDrag||a(H).css({cursor:"default"});k.scrollbar&&(a("."+O).css({margin:k.scrollbarMargin,overflow:"hidden",display:"none"}),a("."+O+" ."+t).css({border:k.scrollbarBorder}),T=parseInt(a("."+O).css("marginLeft"))+parseInt(a("."+O).css("marginRight")),U=parseInt(a("."+O+" ."+t).css("borderLeftWidth"),
10)+parseInt(a("."+O+" ."+t).css("borderRightWidth"),10),P=""!=k.scrollbarContainer?a(k.scrollbarContainer).width():G,E=G/da*(P-T),k.scrollbarHide||(wa=k.scrollbarOpacity),a("."+O).css({position:"absolute",left:0,width:P-T+"px",margin:k.scrollbarMargin}),"top"==k.scrollbarLocation?a("."+O).css("top","0"):a("."+O).css("bottom","0"),a("."+O+" ."+t).css({borderRadius:k.scrollbarBorderRadius,background:k.scrollbarBackground,height:k.scrollbarHeight,width:E-U+"px",minWidth:k.scrollbarHeight,border:k.scrollbarBorder,
webkitPerspective:1E3,webkitBackfaceVisibility:"hidden",position:"relative",opacity:wa,filter:"alpha(opacity:"+100*wa+")",boxShadow:k.scrollbarShadow}),m.setSliderOffset(a("."+O+" ."+t),Math.floor((-1*v[J[h]]-q[h]+r)/(C[h]-q[h]+r)*(P-T-E))),a("."+O).css({display:"block"}),L=a("."+O+" ."+t),V=a("."+O));k.scrollbarDrag&&!ea&&a("."+O+" ."+t).css({cursor:u});k.infiniteSlider&&(Z=(C[h]+G)/3);""!=k.navSlideSelector&&a(k.navSlideSelector).each(function(b){a(this).css({cursor:"pointer"});a(this).unbind(ca).bind(ca,
function(c){"touchstart"==c.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ca=c.type+".iosSliderEvent";m.changeSlide(b,H,I,B,t,E,G,P,T,U,W,v,S,h,Z,M,r,k)})});""!=k.navPrevSelector&&(a(k.navPrevSelector).css({cursor:"pointer"}),a(k.navPrevSelector).unbind(ca).bind(ca,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ca=b.type+".iosSliderEvent";b=(J[h]+K[h]+M)%M;(0<b||k.infiniteSlider)&&m.changeSlide(b-
1,H,I,B,t,E,G,P,T,U,W,v,S,h,Z,M,r,k)}));""!=k.navNextSelector&&(a(k.navNextSelector).css({cursor:"pointer"}),a(k.navNextSelector).unbind(ca).bind(ca,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ca=b.type+".iosSliderEvent";b=(J[h]+K[h]+M)%M;(b<v.length-1||k.infiniteSlider)&&m.changeSlide(b+1,H,I,B,t,E,G,P,T,U,W,v,S,h,Z,M,r,k)}));k.autoSlide&&!ea&&""!=k.autoSlideToggleSelector&&(a(k.autoSlideToggleSelector).css({cursor:"pointer"}),
a(k.autoSlideToggleSelector).unbind(ca).bind(ca,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ca=b.type+".iosSliderEvent";na?(m.autoSlide(H,I,B,t,E,G,P,T,U,W,v,S,h,Z,M,r,k),na=!1,a(k.autoSlideToggleSelector).removeClass("on")):(m.autoSlidePause(h),na=!0,a(k.autoSlideToggleSelector).addClass("on"))}));m.autoSlide(H,I,B,t,E,G,P,T,U,W,v,S,h,Z,M,r,k);a(F).bind("mouseleave.iosSliderEvent",function(){if(na)return!0;m.autoSlide(H,I,B,
t,E,G,P,T,U,W,v,S,h,Z,M,r,k)});a(F).bind("touchend.iosSliderEvent",function(){if(na)return!0;m.autoSlide(H,I,B,t,E,G,P,T,U,W,v,S,h,Z,M,r,k)});k.autoSlideHoverPause&&a(F).bind("mouseenter.iosSliderEvent",function(){m.autoSlidePause(h)});a(F).data("iosslider",{obj:Ea,settings:k,scrollerNode:H,slideNodes:I,numberOfSlides:M,centeredSlideOffset:r,sliderNumber:h,originalOffsets:W,childrenOffsets:v,sliderMax:C[h],scrollbarClass:t,scrollbarWidth:E,scrollbarStageWidth:P,stageWidth:G,scrollMargin:T,scrollBorder:U,
infiniteSliderOffset:K[h],infiniteSliderWidth:Z,slideNodeOuterWidths:S,shortContent:ea});va=!1;return!0}b++;var h=b,B=[];R[h]=a.extend({},k);q[h]=0;C[h]=0;var p=[0,0],N=[0,0],O="scrollbarBlock"+b,t="scrollbar"+b,L,V,P,E,y,Y,r=0,F=a(this),G,ma,T,U,Ba,va=!0;f=-1;var v,W=[],wa=0,ha=0,Fa=0,H=a(this).children(":first-child"),I,ja,S,M=a(H).children().not("script").length,fa=!1,Da=0,ya=!1,sa=void 0,Z;K[h]=0;var ea=!1,na=!1;la[h]=!1;var ia,ta=!1,oa=!1,ca="touchstart.iosSliderEvent click.iosSliderEvent",da,
xa,Ca,ra;ga[h]=!1;X[h]=[];k.scrollbarDrag&&(k.scrollbar=!0,k.scrollbarHide=!1);var Ea=a(this);if(void 0!=Ea.data("iosslider"))return!0;var pa=[],qa=Math.floor(12317*Math.random());a(H).parent().append("<i class = 'i"+qa+"'></i>").append("<i class = 'i"+qa+"'></i>");a(".i"+qa).css({position:"absolute",right:"10px",bottom:"10px",zIndex:1E3,fontStyle:"normal",background:"#fff",opacity:.2}).eq(1).css({bottom:"auto",right:"auto",top:"10px",left:"10px"});for(f=0;f<pa.length;f++)a(".i"+qa).html(a(".i"+qa).html()+
pa[f]);14.2<=parseInt(a().jquery.split(".").join(""),10)?a(this).delegate("img","dragstart.iosSliderEvent",function(a){a.preventDefault()}):a(this).find("img").bind("dragstart.iosSliderEvent",function(a){a.preventDefault()});k.infiniteSlider&&(k.scrollbar=!1);k.infiniteSlider&&1==M&&(k.infiniteSlider=!1);k.scrollbar&&(""!=k.scrollbarContainer?a(k.scrollbarContainer).append("<div class = '"+O+"'><div class = '"+t+"'></div></div>"):a(H).parent().append("<div class = '"+O+"'><div class = '"+t+"'></div></div>"));
if(!x())return!0;a(this).find("a").bind("mousedown",m.preventDrag);a(this).find("[onclick]").bind("click",m.preventDrag).each(function(){a(this).data("onclick",this.onclick)});f=m.calcActiveOffset(k,m.getSliderOffset(a(H),"x"),v,G,K[h],M,void 0,h);f=(f+K[h]+M)%M;f=new m.args("load",k,H,a(H).children(":eq("+f+")"),f,f);a(F).data("args",f);if(""!=k.onSliderLoaded)k.onSliderLoaded(f);if(R[h].responsiveSlides||R[h].responsiveSlideContainer)f=l?"orientationchange":"resize",a(window).bind(f+".iosSliderEvent-"+
h,function(){if(!x())return!0;var b=a(F).data("args");if(""!=k.onSliderResize)k.onSliderResize(b)});!k.keyboardControls&&!k.tabToAdvance||ea||a(document).bind("keydown.iosSliderEvent",function(a){n||w||(a=a.originalEvent);if(ga[h])return!0;if(37==a.keyCode&&k.keyboardControls)a.preventDefault(),a=(J[h]+K[h]+M)%M,(0<a||k.infiniteSlider)&&m.changeSlide(a-1,H,I,B,t,E,G,P,T,U,W,v,S,h,Z,M,r,k);else if(39==a.keyCode&&k.keyboardControls||9==a.keyCode&&k.tabToAdvance)a.preventDefault(),a=(J[h]+K[h]+M)%M,
(a<v.length-1||k.infiniteSlider)&&m.changeSlide(a+1,H,I,B,t,E,G,P,T,U,W,v,S,h,Z,M,r,k)});if(g||k.desktopClickDrag){var ka=!1,za=!1;f=a(H);var ua=a(H),Aa=!1;k.scrollbarDrag&&(f=f.add(L),ua=ua.add(V));a(f).bind("mousedown.iosSliderEvent touchstart.iosSliderEvent",function(b){if(ka)return!0;ka=!0;za=!1;"touchstart"==b.type?a(ua).unbind("mousedown.iosSliderEvent"):a(ua).unbind("touchstart.iosSliderEvent");if(ga[h]||ea||(Aa=m.isUnselectable(b.target,k)))return fa=ka=!1,!0;ia=a(this)[0]===a(L)[0]?L:H;n||
w||(b=b.originalEvent);m.autoSlidePause(h);ra.unbind(".disableClick");if("touchstart"==b.type)eventX=b.touches[0].pageX,eventY=b.touches[0].pageY;else{if(window.getSelection)window.getSelection().empty?window.getSelection().empty():window.getSelection().removeAllRanges&&window.getSelection().removeAllRanges();else if(document.selection)if(w)try{document.selection.empty()}catch(Ga){}else document.selection.empty();eventX=b.pageX;eventY=b.pageY;ya=!0;sa=H;a(this).css({cursor:z})}p=[0,0];N=[0,0];c=0;
fa=!1;for(b=0;b<B.length;b++)clearTimeout(B[b]);b=m.getSliderOffset(H,"x");b>-1*q[h]+r+da?(b=-1*q[h]+r+da,m.setSliderOffset(a("."+t),b),a("."+t).css({width:E-U+"px"})):b<-1*C[h]&&(m.setSliderOffset(a("."+t),P-T-E),a("."+t).css({width:E-U+"px"}));b=a(this)[0]===a(L)[0]?q[h]:0;ha=-1*(m.getSliderOffset(this,"x")-eventX-b);m.getSliderOffset(this,"y");p[1]=eventX;N[1]=eventY;oa=!1});a(document).bind("touchmove.iosSliderEvent mousemove.iosSliderEvent",function(b){n||w||(b=b.originalEvent);if(ga[h]||ea||
Aa||!ka)return!0;var g=0;if("touchmove"==b.type)eventX=b.touches[0].pageX,eventY=b.touches[0].pageY;else{if(window.getSelection)window.getSelection().empty||window.getSelection().removeAllRanges&&window.getSelection().removeAllRanges();else if(document.selection)if(w)try{document.selection.empty()}catch(Ha){}else document.selection.empty();eventX=b.pageX;eventY=b.pageY;if(!ya||!D&&("undefined"!=typeof b.webkitMovementX||"undefined"!=typeof b.webkitMovementY)&&0===b.webkitMovementY&&0===b.webkitMovementX)return!0}p[0]=
p[1];p[1]=eventX;c=(p[1]-p[0])/2;N[0]=N[1];N[1]=eventY;d=(N[1]-N[0])/2;if(!fa){var f=(J[h]+K[h]+M)%M,f=new m.args("start",k,H,a(H).children(":eq("+f+")"),f,void 0);a(F).data("args",f);if(""!=k.onSlideStart)k.onSlideStart(f)}(d>k.verticalSlideLockThreshold||d<-1*k.verticalSlideLockThreshold)&&"touchmove"==b.type&&!fa&&(ta=!0);(c>k.horizontalSlideLockThreshold||c<-1*k.horizontalSlideLockThreshold)&&"touchmove"==b.type&&b.preventDefault();if(c>k.slideStartVelocityThreshold||c<-1*k.slideStartVelocityThreshold)fa=
!0;if(fa&&!ta){var f=m.getSliderOffset(H,"x"),x=a(ia)[0]===a(L)[0]?q[h]:r,l=a(ia)[0]===a(L)[0]?(q[h]-C[h]-r)/(P-T-E):1,A=a(ia)[0]===a(L)[0]?k.scrollbarElasticPullResistance:k.elasticPullResistance,B=k.snapSlideCenter&&a(ia)[0]===a(L)[0]?0:r,u=k.snapSlideCenter&&a(ia)[0]===a(L)[0]?r:0;"touchmove"==b.type&&(Fa!=b.touches.length&&(ha=-1*f+eventX),Fa=b.touches.length);if(k.infiniteSlider){if(f<=-1*C[h]){var z=a(H).width();if(f<=-1*ba[h]){var Q=-1*W[0];a(I).each(function(b){m.setSliderOffset(a(I)[b],Q+
r);b<v.length&&(v[b]=-1*Q);Q+=S[b]});ha-=-1*v[0];q[h]=-1*v[0]+r;C[h]=q[h]+z-G;K[h]=0}else{var y=0,O=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")<O&&(O=m.getSliderOffset(this,"x"),y=a)});A=q[h]+z;m.setSliderOffset(a(I)[y],A);q[h]=-1*v[1]+r;C[h]=q[h]+z-G;v.splice(0,1);v.splice(v.length,0,-1*A+r);K[h]++}}if(f>=-1*q[h]||0<=f)if(z=a(H).width(),0<=f)for(Q=-1*W[0],a(I).each(function(b){m.setSliderOffset(a(I)[b],Q+r);b<v.length&&(v[b]=-1*Q);Q+=S[b]}),ha+=-1*v[0],q[h]=-1*
v[0]+r,C[h]=q[h]+z-G,K[h]=M;0<-1*v[0]-z+r;){var V=0,R=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")>R&&(R=m.getSliderOffset(this,"x"),V=a)});A=q[h]-S[V];m.setSliderOffset(a(I)[V],A);v.splice(0,0,-1*A+r);v.splice(v.length-1,1);q[h]=-1*v[0]+r;C[h]=q[h]+z-G;K[h]--;J[h]++}else V=0,R=m.getSliderOffset(a(I[0]),"x"),a(I).each(function(a){m.getSliderOffset(this,"x")>R&&(R=m.getSliderOffset(this,"x"),V=a)}),A=q[h]-S[V],m.setSliderOffset(a(I)[V],A),v.splice(0,0,-1*A+r),v.splice(v.length-
1,1),q[h]=-1*v[0]+r,C[h]=q[h]+z-G,K[h]--}else z=a(H).width(),f>-1*q[h]+r&&(g=(q[h]+-1*(ha-x-eventX+B)*l-x)*A*-1/l),f<-1*C[h]&&(g=(C[h]+u+-1*(ha-x-eventX)*l-x)*A*-1/l);m.setSliderOffset(H,-1*(ha-x-eventX-g)*l-x+u);k.scrollbar&&(m.showScrollbar(k,t),e=Math.floor((ha-eventX-g-q[h]+B)/(C[h]-q[h]+r)*(P-T-E)*l),f=E,0>=e?(f=E-U- -1*e,m.setSliderOffset(a("."+t),0),a("."+t).css({width:f+"px"})):e>=P-T-U-E?(f=P-T-U-e,m.setSliderOffset(a("."+t),e),a("."+t).css({width:f+"px"})):m.setSliderOffset(a("."+t),e));
"touchmove"==b.type&&(Ba=b.touches[0].pageX);b=!1;g=m.calcActiveOffset(k,-1*(ha-eventX-g),v,G,K[h],M,void 0,h);f=(g+K[h]+M)%M;k.infiniteSlider?f!=aa[h]&&(b=!0):g!=J[h]&&(b=!0);if(b&&(J[h]=g,aa[h]=f,oa=!0,f=new m.args("change",k,H,a(H).children(":eq("+f+")"),f,f),a(F).data("args",f),""!=k.onSlideChange))k.onSlideChange(f)}});pa=a(window);if(w||n)pa=a(document);a(f).bind("touchcancel.iosSliderEvent touchend.iosSliderEvent",function(a){a=a.originalEvent;if(za)return!1;za=!0;if(ga[h]||ea||Aa)return!0;
if(0!=a.touches.length)for(var b=0;b<a.touches.length;b++)a.touches[b].pageX==Ba&&m.slowScrollHorizontal(H,I,B,t,c,d,E,G,P,T,U,W,v,S,h,Z,M,ia,oa,r,k);else m.slowScrollHorizontal(H,I,B,t,c,d,E,G,P,T,U,W,v,S,h,Z,M,ia,oa,r,k);ka=ta=!1;return!0});a(pa).bind("mouseup.iosSliderEvent-"+h,function(b){fa?xa.unbind("click.disableClick").bind("click.disableClick",m.preventClick):xa.unbind("click.disableClick").bind("click.disableClick",m.enableClick);Ca.each(function(){this.onclick=function(b){if(fa)return!1;
a(this).data("onclick")&&a(this).data("onclick").call(this,b||window.event)};this.onclick=a(this).data("onclick")});1.8<=parseFloat(a().jquery)?ra.each(function(){var b=a._data(this,"events");if(void 0!=b&&void 0!=b.click&&"iosSliderEvent"!=b.click[0].namespace){if(!fa)return!1;a(this).one("click.disableClick",m.preventClick);var b=a._data(this,"events").click,c=b.pop();b.splice(0,0,c)}}):1.6<=parseFloat(a().jquery)&&ra.each(function(){var b=a(this).data("events");if(void 0!=b&&void 0!=b.click&&"iosSliderEvent"!=
b.click[0].namespace){if(!fa)return!1;a(this).one("click.disableClick",m.preventClick);var b=a(this).data("events").click,c=b.pop();b.splice(0,0,c)}});if(!la[h]){if(ea)return!0;k.desktopClickDrag&&a(H).css({cursor:u});k.scrollbarDrag&&a(L).css({cursor:u});ya=!1;if(void 0==sa)return!0;m.slowScrollHorizontal(sa,I,B,t,c,d,E,G,P,T,U,W,v,S,h,Z,M,ia,oa,r,k);sa=void 0}ka=ta=!1})}})},destroy:function(b,c){void 0==c&&(c=this);return a(c).each(function(){var c=a(this),d=c.data("iosslider");if(void 0==d)return!1;
void 0==b&&(b=!0);m.autoSlidePause(d.sliderNumber);la[d.sliderNumber]=!0;a(window).unbind(".iosSliderEvent-"+d.sliderNumber);a(document).unbind(".iosSliderEvent-"+d.sliderNumber);a(document).unbind("keydown.iosSliderEvent");a(this).unbind(".iosSliderEvent");a(this).children(":first-child").unbind(".iosSliderEvent");a(this).children(":first-child").children().unbind(".iosSliderEvent");b&&(a(this).attr("style",""),a(this).children(":first-child").attr("style",""),a(this).children(":first-child").children().attr("style",
...
a(this),c=b.data("iosslider");if(void 0==c)return!1;c.settings.startAtSlide=b.data("args").currentSlideNumber;Y.destroy(!1,this);1!=c.numberOfSlides&&c.settings.infiniteSlider&&(c.settings.startAtSlide=(J[c.sliderNumber]+1+K[c.sliderNumber]+c.numberOfSlides)%c.numberOfSlides);Y.init(c.settings,this);b=new m.args("update",c.settings,c.scrollerNode,a(c.scrollerNode).children(":eq("+(c.settings.startAtSlide-1)+")"),c.settings.startAtSlide-1,c.settings.startAtSlide-1);a(c.stageNode).data("args",b);if(""!=
...
b.bgOverlay||(b.bgOverlay=u("bg").on("click.mfp",function(){b.close()}),b.wrap=u("wrap").attr("tabindex",-1).on("click.mfp",function(a){b._checkIfClose(a.target)&&b.close()}),b.container=u("container",b.wrap));b.contentContainer=u("content");b.st.preloader&&(b.preloader=u("preloader",b.container,b.st.tLoading));f=a.magnificPopup.modules;for(k=0;f.length>k;k++)g=f[k],g=g.charAt(0).toUpperCase()+g.slice(1),b["init"+g].call(b);z("BeforeOpen");b.st.showCloseBtn&&(b.st.closeBtnInside?(p("MarkupParse",
function(a,b,c,d){c.close_replaceWith=V(d.type)}),l+=" mfp-close-btn-in"):b.wrap.append(V()));b.st.alignTop&&(l+=" mfp-align-top");b.fixedContentPos?b.wrap.css({overflow:b.st.overflowY,overflowX:"hidden",overflowY:b.st.overflowY}):b.wrap.css({top:D.scrollTop(),position:"absolute"});(!1===b.st.fixedBgPos||"auto"===b.st.fixedBgPos&&!b.fixedContentPos)&&b.bgOverlay.css({height:e.height(),position:"absolute"});b.st.enableEscapeKey&&e.on("keyup.mfp",function(a){27===a.keyCode&&b.close()});D.on("resize.mfp",
function(){b.updateSize()});b.st.closeOnContentClick||(l+=" mfp-auto-cursor");l&&b.wrap.addClass(l);k=b.wH=D.height();f={};b.fixedContentPos&&b._hasScrollBar(k)&&(g=b._getScrollbarSize())&&(f.marginRight=g);b.fixedContentPos&&(b.isIE7?a("body, html").css("overflow","hidden"):f.overflow="hidden");g=b.st.mainClass;return b.isIE7&&(g+=" mfp-ie7"),g&&b._addClassToMFP(g),b.updateItemHTML(),z("BuildControls"),a("html").css(f),b.bgOverlay.add(b.wrap).prependTo(b.st.prependTo||d),b._lastFocusedEl=document.activeElement,
setTimeout(function(){b.content?(b._addClassToMFP("mfp-ready"),b._setFocus()):b.bgOverlay.addClass("mfp-ready");e.on("focusin.mfp",b._onFocusIn)},16),b.isOpen=!0,b.updateSize(k),z("Open"),c},close:function(){b.isOpen&&(z("BeforeClose"),b.isOpen=!1,b.st.removalDelay&&!b.isLowIE&&b.supportsTransition?(b._addClassToMFP("mfp-removing"),setTimeout(function(){b._close()},b.st.removalDelay)):b._close())},_close:function(){z("Close");var c="mfp-removing mfp-ready ";if(b.bgOverlay.detach(),b.wrap.detach(),
b.container.empty(),b.st.mainClass&&(c+=b.st.mainClass+" "),b._removeClassFromMFP(c),b.fixedContentPos)c={marginRight:""},b.isIE7?a("body, html").css("overflow",""):c.overflow="",a("html").css(c);e.off("keyup.mfp focusin.mfp");b.ev.off(".mfp");b.wrap.attr("class","mfp-wrap").removeAttr("style");b.bgOverlay.attr("class","mfp-bg");b.container.attr("class","mfp-container");!b.st.showCloseBtn||b.st.closeBtnInside&&!0!==b.currTemplate[b.currItem.type]||b.currTemplate.closeBtn&&b.currTemplate.closeBtn.detach();
b._lastFocusedEl&&a(b._lastFocusedEl).focus();b.currItem=null;b.content=null;b.currTemplate=null;b.prevHeight=0;z("AfterClose")},updateSize:function(a){b.isIOS?(a=document.documentElement.clientWidth/window.innerWidth*window.innerHeight,b.wrap.css("height",a),b.wH=a):b.wH=a||D.height();b.fixedContentPos||b.wrap.css("height",b.wH);z("Resize")},updateItemHTML:function(){var c=b.items[b.index];b.contentContainer.detach();b.content&&b.content.detach();c.parsed||(c=b.parseEl(b.index));var d=c.type;if(z("BeforeChange",
[b.currItem?b.currItem.type:"",d]),b.currItem=c,!b.currTemplate[d]){var e=b.st[d]?b.st[d].markup:!1;z("FirstMarkupParse",e);b.currTemplate[d]=e?a(e):!0}g&&g!==c.type&&b.container.removeClass("mfp-"+g+"-holder");e=b["get"+d.charAt(0).toUpperCase()+d.slice(1)](c,b.currTemplate[d]);b.appendContent(e,d);c.preloaded=!0;z("Change",c);g=c.type;b.container.prepend(b.contentContainer);z("AfterChange")},appendContent:function(a,c){(b.content=a)?b.st.showCloseBtn&&b.st.closeBtnInside&&!0===b.currTemplate[c]?
b.content.find(".mfp-close").length||b.content.append(V()):b.content=a:b.content="";z("BeforeAppend");b.container.addClass("mfp-"+c+"-holder");b.contentContainer.append(b.content)},parseEl:function(c){var d,e=b.items[c];if(e.tagName?e={el:a(e)}:(d=e.type,e={data:e,src:e.src}),e.el){for(var k=b.types,f=0;k.length>f;f++)if(e.el.hasClass("mfp-"+k[f])){d=k[f];break}e.src=e.el.attr("data-mfp-src");e.src||(e.src=e.el.attr("href"))}return e.type=d||b.st.type||"inline",e.index=c,e.parsed=!0,b.items[c]=e,
...
0;f.items?e=f.items[g]:(e=d,f.delegate&&(e=e.find(f.delegate)),e=e.eq(g));b._openClick({mfpEl:e},d,f)}else b.isOpen&&b[c].apply(b,Array.prototype.slice.call(arguments,1));else c=a.extend(!0,{},c),w?d.data("magnificPopup",c):d[0].magnificPopup=c,b.addGroup(d,c);return d};var X,J,aa,K=function(){aa&&(J.after(aa.addClass(X)).detach(),aa=null)};a.magnificPopup.registerModule("inline",{options:{hiddenClass:"hide",markup:"",tNotFound:"Content not found"},proto:{initInline:function(){b.types.push("inline");
p("Close.inline",function(){K()})},getInline:function(c,d){if(K(),c.src){var e=b.st.inline,f=a(c.src);if(f.length){var g=f[0].parentNode;g&&g.tagName&&(J||(X=e.hiddenClass,J=u(X),X="mfp-"+X),aa=f.after(J).detach().removeClass(X));b.updateStatus("ready")}else b.updateStatus("error",e.tNotFound),f=a("<div>");return c.inlineElement=f,f}return b.updateStatus("ready"),b._parseMarkup(d,{},c),d}}});var q,C=function(){q&&d.removeClass(q);b.req&&b.req.abort()};a.magnificPopup.registerModule("ajax",{options:{settings:null,
cursor:"mfp-ajax-cur",tError:'<a href="%url%">The content</a> could not be loaded.'},proto:{initAjax:function(){b.types.push("ajax");q=b.st.ajax.cursor;p("Close.ajax",C);p("BeforeChange.ajax",C)},getAjax:function(c){q&&d.addClass(q);b.updateStatus("loading");var e=a.extend({url:c.src,success:function(e,f,g){e={data:e,xhr:g};z("ParseAjax",e);b.appendContent(a(e.data),"ajax");c.finished=!0;q&&d.removeClass(q);b._setFocus();setTimeout(function(){b.wrap.addClass("mfp-ready")},16);b.updateStatus("ready");
z("AjaxContentAdded")},error:function(){q&&d.removeClass(q);c.finished=c.loadError=!0;b.updateStatus("error",b.st.ajax.tError.replace("%url%",c.src))}},b.st.ajax.settings);return b.req=a.ajax(e),""}}});var ba,ga=function(c){if(c.data&&void 0!==c.data.title)return c.data.title;var d=b.st.image.titleSrc;if(d){if(a.isFunction(d))return d.call(b,c);if(c.el)return c.el.attr(d)||""}return""};a.magnificPopup.registerModule("image",{options:{markup:'<div class="mfp-figure"><div class="mfp-close"></div><figure><div class="mfp-img"></div><figcaption><div class="mfp-bottom-bar"><div class="mfp-title"></div><div class="mfp-counter"></div></div></figcaption></figure></div>',
cursor:"mfp-zoom-out-cur",titleSrc:"title",verticalFit:!0,tError:'<a href="%url%">The image</a> could not be loaded.'},proto:{initImage:function(){var a=b.st.image;b.types.push("image");p("Open.image",function(){"image"===b.currItem.type&&a.cursor&&d.addClass(a.cursor)});p("Close.image",function(){a.cursor&&d.removeClass(a.cursor);D.off("resize.mfp")});p("Resize.image",b.resizeImage);b.isLowIE&&p("AfterChange",b.resizeImage)},resizeImage:function(){var a=b.currItem;if(a&&a.img&&b.st.image.verticalFit){var c=
0;b.isLowIE&&(c=parseInt(a.img.css("padding-top"),10)+parseInt(a.img.css("padding-bottom"),10));a.img.css("max-height",b.wH-c)}},_onImageHasSize:function(a){a.img&&(a.hasSize=!0,ba&&clearInterval(ba),a.isCheckingImgSize=!1,z("ImageHasSize",a),a.imgHidden&&(b.content&&b.content.removeClass("mfp-loading"),a.imgHidden=!1))},findImageSize:function(a){var c=0,d=a.img[0],e=function(f){ba&&clearInterval(ba);ba=setInterval(function(){return 0<d.naturalWidth?(b._onImageHasSize(a),void 0):(200<c&&clearInterval(ba),
...
zIndex:9999,left:0,top:0,"-webkit-backface-visibility":"hidden"};return b["-webkit-transition"]=b["-moz-transition"]=b["-o-transition"]=b.transition="all "+c.duration/1E3+"s "+c.easing,a.css(b),a},l=function(){b.content.css("visibility","visible")};p("BuildControls.zoom",function(){if(b._allowZoom()){if(clearTimeout(d),b.content.css("visibility","hidden"),a=b._getItemToZoom(),!a)return l(),void 0;e=g(a);e.css(b._getOffset());b.wrap.append(e);d=setTimeout(function(){e.css(b._getOffset(!0));d=setTimeout(function(){l();
setTimeout(function(){e.remove();a=e=null;z("ZoomAnimationEnded")},16)},f)},16)}});p("BeforeClose.zoom",function(){if(b._allowZoom()){if(clearTimeout(d),b.st.removalDelay=f,!a){if(a=b._getItemToZoom(),!a)return;e=g(a)}e.css(b._getOffset(!0));b.wrap.append(e);b.content.css("visibility","hidden");setTimeout(function(){e.css(b._getOffset())},16)}});p("Close.zoom",function(){b._allowZoom()&&(l(),e&&e.remove(),a=null)})}},_allowZoom:function(){return"image"===b.currItem.type},_getItemToZoom:function(){return b.currItem.hasSize?
b.currItem.img:!1},_getOffset:function(c){var d;d=c?b.currItem.img:b.st.zoom.opener(b.currItem.el||b.currItem);c=d.offset();var e=parseInt(d.css("padding-top"),10),f=parseInt(d.css("padding-bottom"),10);c.top-=a(window).scrollTop()-e;d={width:d.width(),height:(w?d.innerHeight():d[0].offsetHeight)-f-e};return(void 0===m&&(m=void 0!==document.createElement("p").style.MozTransform),m)?d["-moz-transform"]=d.transform="translate("+c.left+"px,"+c.top+"px)":(d.left=c.left,d.top=c.top),d}}});var Y=function(a){if(b.currTemplate.iframe){var c=
b.currTemplate.iframe.find("iframe");c.length&&(a||(c[0].src="//about:blank"),b.isIE8&&c.css("display",a?"block":"none"))}};a.magnificPopup.registerModule("iframe",{options:{markup:'<div class="mfp-iframe-scaler"><div class="mfp-close"></div><iframe class="mfp-iframe" src="//about:blank" frameborder="0" allowfullscreen></iframe></div>',srcAction:"iframe_src",patterns:{youtube:{index:"youtube.com",id:"v=",src:"//www.youtube.com/embed/%id%?autoplay=1"},vimeo:{index:"vimeo.com/",id:"/",src:"//player.vimeo.com/video/%id%?autoplay=1"},
gmaps:{index:"//maps.google.",src:"%id%&output=embed"}}},proto:{initIframe:function(){b.types.push("iframe");p("BeforeChange",function(a,b,c){b!==c&&("iframe"===b?Y():"iframe"===c&&Y(!0))});p("Close.iframe",function(){Y()})},getIframe:function(c,d){var e=c.src,f=b.st.iframe;a.each(f.patterns,function(){return-1<e.indexOf(this.index)?(this.id&&(e="string"==typeof this.id?e.substr(e.lastIndexOf(this.id)+this.id.length,e.length):this.id.call(this,e)),e=this.src.replace("%id%",e),!1):void 0});var g={};
return f.srcAction&&(g[f.srcAction]=e),b._parseMarkup(d,g,c),b.updateStatus("ready"),d}}});var B=function(a){var c=b.items.length;return a>c-1?a-c:0>a?c+a:a},N=function(a,b,c){return a.replace(/%curr%/gi,b+1).replace(/%total%/gi,c)};a.magnificPopup.registerModule("gallery",{options:{enabled:!1,arrowMarkup:'<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"></button>',preload:[0,2],navigateByImgClick:!0,arrows:!0,tPrev:"Previous (Left arrow key)",tNext:"Next (Right arrow key)",
tCounter:"%curr% of %total%"},proto:{initGallery:function(){var c=b.st.gallery,d=!!a.fn.mfpFastClick;return b.direction=!0,c&&c.enabled?(l+=" mfp-gallery",p("Open.mfp-gallery",function(){c.navigateByImgClick&&b.wrap.on("click.mfp-gallery",".mfp-img",function(){return 1<b.items.length?(b.next(),!1):void 0});e.on("keydown.mfp-gallery",function(a){37===a.keyCode?b.prev():39===a.keyCode&&b.next()})}),p("UpdateStatus.mfp-gallery",function(a,c){c.text&&(c.text=N(c.text,b.currItem.index,b.items.length))}),
p("MarkupParse.mfp-gallery",function(a,d,e,f){a=b.items.length;e.counter=1<a?N(c.tCounter,f.index,a):""}),p("BuildControls.mfp-gallery",function(){if(1<b.items.length&&c.arrows&&!b.arrowLeft){var e=c.arrowMarkup,f=b.arrowLeft=a(e.replace(/%title%/gi,c.tPrev).replace(/%dir%/gi,"left")).addClass("mfp-prevent-close"),e=b.arrowRight=a(e.replace(/%title%/gi,c.tNext).replace(/%dir%/gi,"right")).addClass("mfp-prevent-close"),g=d?"mfpFastClick":"click";f[g](function(){b.prev()});e[g](function(){b.next()});
b.isIE7&&(u("b",f[0],!1,!0),u("a",f[0],!1,!0),u("b",e[0],!1,!0),u("a",e[0],!1,!0));b.container.append(f.add(e))}}),p("Change.mfp-gallery",function(){b._preloadTimeout&&clearTimeout(b._preloadTimeout);b._preloadTimeout=setTimeout(function(){b.preloadNearbyImages();b._preloadTimeout=null},16)}),p("Close.mfp-gallery",function(){e.off(".mfp-gallery");b.wrap.off("click.mfp-gallery");b.arrowLeft&&d&&b.arrowLeft.add(b.arrowRight).destroyMfpFastClick();b.arrowRight=b.arrowLeft=null}),void 0):!1},next:function(){b.direction=
!0;b.index=B(b.index+1);b.updateItemHTML()},prev:function(){b.direction=!1;b.index=B(b.index-1);b.updateItemHTML()},goTo:function(a){b.direction=a>=b.index;b.index=a;b.updateItemHTML()},preloadNearbyImages:function(){var a;a=b.st.gallery.preload;var c=Math.min(a[0],b.items.length),d=Math.min(a[1],b.items.length);for(a=1;(b.direction?d:c)>=a;a++)b._preloadItem(b.index+a);for(a=1;(b.direction?c:d)>=a;a++)b._preloadItem(b.index-a)},_preloadItem:function(c){if(c=B(c),!b.items[c].preloaded){var d=b.items[c];
...
c():c;1<c&&(p("ImageHasSize.retina",function(a,b){b.img.css({"max-width":b.img[0].naturalWidth/c,width:"100%"})}),p("ElementParse.retina",function(b,d){d.src=a.replaceSrc(d,c)}))}}}});(function(){var b="ontouchstart"in window,c=function(){D.off("touchmove"+d+" touchend"+d)},d=".mfpFastClick";a.fn.mfpFastClick=function(e){return a(this).each(function(){var f,g=a(this);if(b){var h,l,k,n,m,w;g.on("touchstart"+d,function(a){n=!1;w=1;m=a.originalEvent?a.originalEvent.touches[0]:a.touches[0];l=m.clientX;
k=m.clientY;D.on("touchmove"+d,function(a){m=a.originalEvent?a.originalEvent.touches:a.touches;w=m.length;m=m[0];(10<Math.abs(m.clientX-l)||10<Math.abs(m.clientY-k))&&(n=!0,c())}).on("touchend"+d,function(a){c();n||1<w||(f=!0,a.preventDefault(),clearTimeout(h),h=setTimeout(function(){f=!1},1E3),e())})})}g.on("click"+d,function(){f||e()})})};a.fn.destroyMfpFastClick=function(){a(this).off("touchstart"+d+" click"+d);b&&D.off("touchmove"+d+" touchend"+d)}})();R()})(window.jQuery||window.Zepto);
(function(a,b,c){function d(a){var b={},d=/^jQuery\d+$/;c.each(a.attributes,function(a,c){c.specified&&!d.test(c.name)&&(b[c.name]=c.value)});return b}function e(a,b){var d=c(this);if(this.value==d.attr("placeholder")&&d.hasClass("placeholder"))if(d.data("placeholder-password")){d=d.hide().next().show().attr("id",d.removeAttr("id").data("placeholder-id"));if(!0===a)return d[0].value=b;d.focus()}else this.value="",d.removeClass("placeholder"),this==l()&&this.select()}function g(){var a,b=c(this),f=
this.id;if(""==this.value){if("password"==this.type){if(!b.data("placeholder-textinput")){try{a=b.clone().attr({type:"text"})}catch(R){a=c("<input>").attr(c.extend(d(this),{type:"text"}))}a.removeAttr("name").data({"placeholder-password":b,"placeholder-id":f}).bind("focus.placeholder",e);b.data({"placeholder-textinput":a,"placeholder-id":f}).before(a)}b=b.removeAttr("id").hide().prev().attr("id",f).show()}b.addClass("placeholder");b[0].value=b.attr("placeholder")}else b.removeClass("placeholder")}
function l(){try{return b.activeElement}catch(u){}}var f="placeholder"in b.createElement("input"),n="placeholder"in b.createElement("textarea"),w=c.fn,D=c.valHooks,p=c.propHooks;f&&n?(w=w.placeholder=function(){return this},w.input=w.textarea=!0):(w=w.placeholder=function(){this.filter((f?"textarea":":input")+"[placeholder]").not(".placeholder").bind({"focus.placeholder":e,"blur.placeholder":g}).data("placeholder-enabled",!0).trigger("blur.placeholder");return this},w.input=f,w.textarea=n,w={get:function(a){var b=
c(a),d=b.data("placeholder-password");return d?d[0].value:b.data("placeholder-enabled")&&b.hasClass("placeholder")?"":a.value},set:function(a,b){var d=c(a),f=d.data("placeholder-password");if(f)return f[0].value=b;if(!d.data("placeholder-enabled"))return a.value=b;""==b?(a.value=b,a!=l()&&g.call(a)):d.hasClass("placeholder")?e.call(a,!0,b)||(a.value=b):a.value=b;return d}},f||(D.input=w,p.value=w),n||(D.textarea=w,p.value=w),c(function(){c(b).delegate("form","submit.placeholder",function(){var a=
...
a.parent().children("ul").hide()):(c=b.siblings(),c.removeClass(tdMenu._openMenuClass),c.find("ul").hide(),c.find("li").removeClass(tdMenu._openMenuClass)),b.addClass(tdMenu._openMenuClass),b.children("ul").show(),tdMenu._getSubmenuPosition(b),d.addClass(tdMenu._openMenuBodyClass))});else{var c={},d,e=!0;b.on("mouseleave",function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();c={}});b.find(".menu-item").hover(function(){var b=jQuery(this),l="",f,n,w,D;b.hasClass("menu-item-has-children")||
b.hasClass("td-mega-menu")?b.parent().hasClass("sf-menu")?jQuery.isEmptyObject(c)?(b.addClass(tdMenu._openMenuClass),b.children("ul").show(),c=b):b[0]!==c[0]&&(w=n=f=0,D=null,!0===e&&(e=!1,d=setTimeout(function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();b.addClass(tdMenu._openMenuClass);b.children("ul").show();c=b},400)),b.on("mousemove",function(g){5<=f?(f=0,D=tdMenu._getMouseAngleDirection(n,w,g.pageX,g.pageY),n=g.pageX,w=g.pageY):(f++,0===n&&0===w&&(n=g.pageX,
w=g.pageY));null!==D&&(85<D||-85>D)&&(a.parent().removeClass(tdMenu._openMenuClass),a.parent().children("ul").hide(),b.addClass(tdMenu._openMenuClass),b.children("ul").show(),b.off("mousemove"),clearTimeout(d),e=!0,c=b)})):(l=b.siblings(),l.removeClass(tdMenu._openMenuClass),l.find("ul").hide(),l.find("li").removeClass(tdMenu._openMenuClass),b.addClass(tdMenu._openMenuClass),b.children("ul").show(),tdMenu._getSubmenuPosition(b)):b.parent().hasClass("sf-menu")||b.parent().hasClass("top-header-menu")?
jQuery.isEmptyObject(c)||(w=n=f=0,D=null,!0===e&&(e=!1,d=setTimeout(function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();c={}},400)),b.on("mousemove",function(g){5<=f?(f=0,D=tdMenu._getMouseAngleDirection(n,w,g.pageX,g.pageY),n=g.pageX,w=g.pageY):(f++,0===n&&0===w&&(n=g.pageX,w=g.pageY));null!==D&&(85<D||-85>D)&&(a.parent().removeClass(tdMenu._openMenuClass),a.parent().children("ul").hide(),b.off("mousemove"),clearTimeout(d),e=!0,c={})})):(c=b.parent(),l=b.siblings(),
...
c;a.style["-moz-transform"]=c;a.style["-ms-transform"]=c;a.style["-o-transform"]=c;a.style.transform=c},isValidUrl:function(a){return/^(https?:\/\/)?((([a-z\d]([a-z\d-]*[a-z\d])*)\.)+[a-z]{2,}|((\d{1,3}\.){3}\d{1,3}))(\:\d+)?(\/[-a-z\d%_.~+]*)*(\?[;&a-z\d%_.~+=-]*)?(\#[-a-z\d_]*)?$/i.test(a)?!0:!1},round:function(a,b,c){var d,e,g;b=Math.pow(10,b|0);a*=b;g=0<a|-(0>a);e=a%1===.5*g;d=Math.floor(a);if(e)switch(c){case "PHP_ROUND_HALF_DOWN":a=d+(0>g);break;case "PHP_ROUND_HALF_EVEN":a=d+d%2*g;break;case "PHP_ROUND_HALF_ODD":a=
d+!(d%2);break;default:a=d+(0<g)}return(e?a:Math.round(a))/b}}})();var tdAffix={};
...
b.addClass("td_block_inner_overflow");var g=b.height();b.css("height",g);!1===c&&("load_more"===d?(b.parent().append('<div class="td-loader-gif td-loader-infinite td-loader-blocks-load-more  td-loader-animation-start"></div>'),tdLoadingBox.init(a.header_color?a.header_color:tds_theme_color_site_wide),setTimeout(function(){jQuery(".td-loader-gif").removeClass("td-loader-animation-start").addClass("td-loader-animation-mid")},50)):"infinite_load"===d?(b.parent().append('<div class="td-loader-gif td-loader-infinite td-loader-animation-start"></div>'),
...
tdBlockAjaxLoadingEnd:function(a,c,d){jQuery(".td-loader-gif").removeClass("td-loader-animation-mid").addClass("td-loader-animation-end");setTimeout(function(){jQuery(".td-loader-gif").remove();tdLoadingBox.stop()},400);var b=jQuery("#"+c.id);b.removeClass("td_animated_long td_fadeOut_to_1");var g;!0===tdAnimationStack.activated&&(g=tdAnimationStack.SORTED_METHOD.sort_left_to_right);switch(d){case "next":b.addClass("td_animated_xlong td_fadeInRight");void 0!==g&&(g=tdAnimationStack.SORTED_METHOD.sort_right_to_left);
break;case "back":b.addClass("td_animated_xlong td_fadeInLeft");break;case "pull_down":b.addClass("td_animated_xlong td_fadeInDown");break;case "mega_menu":b.addClass("td_animated_xlong td_fadeInDown");break;case "load_more":setTimeout(function(){jQuery("."+c.id+"_rand .td_ajax_load_more_js").css("visibility","visible")},500);break;case "infinite_load":setTimeout(function(){tdInfiniteLoader.computeTopDistances();""!==a.td_data&&tdInfiniteLoader.enable_is_visible_callback(c.id)},500),setTimeout(function(){tdInfiniteLoader.computeTopDistances()},
1E3),setTimeout(function(){tdInfiniteLoader.computeTopDistances()},1500)}setTimeout(function(){jQuery(".td_block_inner_overflow").removeClass("td_block_inner_overflow");b.css("height","auto");tdSmartSidebar.compute()},200);setTimeout(function(){tdSmartSidebar.compute()},500);void 0!==g&&setTimeout(function(){tdAnimationStack.check_for_new_items("#"+c.id+" .td-animation-stack",g,!0)},200)},tdGetBlockIndex:function(a){var b=0,d=0;jQuery.each(tdBlocksArray,function(c,g){if(g.id===a)return d=b,!1;b++});
...
window.clearInterval(tdDemoMenu.startInterval);var d=a(this),e=d.closest(".td-set-theme-style"),g=a(".td-screen-demo:first"),l,f=0,n=0;l=a("#wpadminbar");var w=g.find("img:first"),d=d.data("img-url");w.length?w.attr("src",d):g.html('<img src="'+d+'"/>');0===a(".td-set-theme-style-link").index(this)%2?f=2*e.outerWidth(!0):(e=e.prev(".td-set-theme-style"),e.length&&(f=e.outerWidth(!0)-0,n=e.outerWidth(!0)+0),c.preventDefault(),c.stopPropagation());c=c.pageY-document.body.scrollTop-g.outerHeight(!0)/
2;c+g.outerHeight(!0)>window.innerHeight&&(c-=c+g.outerHeight(!0)-window.innerHeight);l=l.length?l.outerHeight(!0):0;l>c&&(c=l);l={top:c,right:f,width:""};c=g.data("width-preview");0<n&&(l.width=c+n);g.css(l);g.data("right-value",f+n);g.css("visibility","visible")},function(c){a(".td-screen-demo-extend:first").hide();var d=a(".td-screen-demo:first");c=d.css("right");var e=d.css("padding-right"),g=d.css("width"),l=parseInt(c.replace("px","")),f=parseInt(e.replace("px","")),n=parseInt(g.replace("px",
""));c=a(this);tdDemoMenu._currentElement=c;var w=parseInt(a("#td-theme-settings").css("width").replace("px",""));0<f?(b!==tdDemoMenu.startTimeout&&(window.clearTimeout(tdDemoMenu.startTimeout),tdDemoMenu.startTimeout=b),b!==tdDemoMenu.startInterval&&(window.clearInterval(tdDemoMenu.startInterval),tdDemoMenu.startInterval=b),tdDemoMenu.startTimeout=setTimeout(function(){tdDemoMenu._extendedDemo=!0;tdDemoMenu.startInterval=setInterval(function(){var c=d.data("width-preview");l+=10;f-=10;n-=10;var e=
!1;if(0>=f||n<c||tdDemoMenu.mousePosX<=a(window).width()-w||tdDemoMenu.mousePosX>=a(window).width()-l)b!==tdDemoMenu.startTimeout&&(window.clearTimeout(tdDemoMenu.startTimeout),tdDemoMenu.startTimeout=b),b!==tdDemoMenu.startInterval&&(window.clearInterval(tdDemoMenu.startInterval),tdDemoMenu.startInterval=b),f=0,l=d.data("right-value"),n=c,tdDemoMenu.mousePosX>=a(window).width()-l&&(e=!0);d.css({right:l,"padding-right":f,width:n});e?(tdDemoMenu._extendedDemo=!1,tdDemoMenu._checkMousePosition()):b===
tdDemoMenu.startTimeout&&b===tdDemoMenu.startInterval&&(tdDemoMenu._extendedDemo=!0,tdDemoMenu._showExtendedScreenDemo())},15)},50)):d.css("visibility","hidden")}).mousemove(function(a){tdDemoMenu._moveScreenDemo(a)});a(".td-screen-demo-extend").hover(function(c){if(tdDemoMenu._extendedDemo){tdDemoMenu._extendedDemo=!1;var d=a(this),e=a(".td-screen-demo:first"),g=parseInt(a("#td-theme-settings").css("width").replace("px",""))/2,l=g;d.css({width:g+"px",top:e.css("top")});d.show();e.css("visibility",
"visible");tdDemoMenu._startExtendedTimeout=setTimeout(function(){tdDemoMenu._startExtendedInterval=setInterval(function(){l-=10;var c=!1;if(0>l||tdDemoMenu.mousePosX<=a(window).width()-g-l)b!==tdDemoMenu._startExtendedTimeout&&(window.clearTimeout(tdDemoMenu._startExtendedTimeout),tdDemoMenu._startExtendedTimeout=b),b!==tdDemoMenu._startExtendedInterval&&(window.clearInterval(tdDemoMenu._startExtendedInterval),tdDemoMenu._startExtendedInterval=b),tdDemoMenu.mousePosX<=a(window).width()-g-l&&(c=!0),
l=g,d.hide();d.css({width:l,top:e.css("top")});c&&tdDemoMenu._checkMousePosition()},15)},50)}},function(c){b!==tdDemoMenu._startExtendedTimeout&&(window.clearTimeout(tdDemoMenu._startExtendedTimeout),tdDemoMenu._startExtendedTimeout=b);b!==tdDemoMenu._startExtendedInterval&&(window.clearInterval(tdDemoMenu._startExtendedInterval),tdDemoMenu._startExtendedInterval=b);tdDemoMenu._resetTdScreeDemoExtendWidth();a(this).hide();a(".td-screen-demo:first").css("visibility","hidden")}).mousemove(function(a){})},
_moveScreenDemo:function(b){var c=a(".td-screen-demo:first"),e=a("#wpadminbar"),g=b.pageY-document.body.scrollTop-c.outerHeight(!0)/2,e=e.length?e.outerHeight(!0):0;e>g&&(g=e);0>g?g=0:a(window).height()-c.outerHeight(!0)/2<b.pageY-document.body.scrollTop&&(g=a(window).height()-c.outerHeight(!0));c.css("top",g)},_resetTdScreeDemoExtendWidth:function(){var b=parseInt(a("#td-theme-settings").css("width").replace("px",""))/2;a(".td-screen-demo-extend:first").css({width:b+"px"})},_showExtendedScreenDemo:function(){tdDemoMenu._extendedDemo&&
a(".td-screen-demo-extend:first").css({top:a(".td-screen-demo:first").css("top")}).show()},_checkMousePosition:function(){var c;a(".td-set-theme-style-link").each(function(b,e){tdDemoMenu._log(b);var d=a(e).closest(".td-set-theme-style"),l=!1,f=!1;if(0===a(".td-set-theme-style-link").index(e)%2)parseInt(d.position().top)+parseInt(a(window).scrollTop())<tdDemoMenu.mousePosY&&tdDemoMenu.mousePosY<parseInt(d.position().top)+parseInt(a(window).scrollTop())+parseInt(d.outerHeight())&&(l=!0,parseInt(a(window).width())-
2*parseInt(d.outerWidth())<tdDemoMenu.mousePosX&&tdDemoMenu.mousePosX<parseInt(a(window).width())-parseInt(d.outerWidth())&&(f=!0));else{var n=d.prev(".td-set-theme-style");n.length&&parseInt(n.position().top)+parseInt(a(window).scrollTop())<tdDemoMenu.mousePosY&&tdDemoMenu.mousePosY<parseInt(n.position().top)+parseInt(a(window).scrollTop())+parseInt(n.outerHeight())&&(l=!0,parseInt(a(window).width())-parseInt(d.outerWidth())<tdDemoMenu.mousePosX&&tdDemoMenu.mousePosX<parseInt(a(window).width())&&
(f=!0))}if(l&&f)return c=e,!1});b===c?a("#td-theme-settings").find(".td-screen-demo:first").css("visibility","hidden"):a(c).mouseenter()},_log:function(a){}}})(jQuery);(function(){if("hide"===td_read_site_cookie("td_show_panel")){var a=jQuery("#td-theme-settings");a.length&&(a.removeClass("td-theme-settings-small"),jQuery("#td-theme-set-hide").html("DEMOS"))}else jQuery("#td-theme-set-hide").html("CLOSE")})();
...
tdTrendingNow.tdTrendingNowChangeText([a,"left"],!0))},tdTrendingNowChangeText:function(a,b){for(var c=a[0],d=a[1],e=[],g=0,l,f=0;f<tdTrendingNow.items.length;f++)tdTrendingNow.items[f].blockUid===c&&(l=f,e=tdTrendingNow.items[f].trendingNowPosts,g=tdTrendingNow.items[f].trendingNowPosition);if("undefined"!==typeof l&&null!==l){c=g;f=e.length-1;"left"===d?(g+=1,g>f&&(g=0)):(--g,0>g&&(g=f));tdTrendingNow.items[l].trendingNowPosition=g;e[c].css("opacity",0);e[c].css("z-index",0);for(var n in e)!0===
...
(b+=tdAffix.menu_offset));"undefined"!==typeof window.tdThemeName&&"Newspaper"===window.tdThemeName&&(b+=20);var d="";a!==tdSmartSidebar.scroll_window_scrollTop_last&&(d=a>tdSmartSidebar.scroll_window_scrollTop_last?"down":"up");tdSmartSidebar.scroll_window_scrollTop_last=a;var e=jQuery(window).height(),g=a+e;a+=b;for(var l=0;l<tdSmartSidebar.items.length;l++){var f=tdSmartSidebar.items[l];f.content_top=f.content_jquery_obj.offset().top;f.content_height=f.content_jquery_obj.height();f.content_bottom=
f.content_top+f.content_height;f.sidebar_top=f.sidebar_jquery_obj.offset().top;f.sidebar_height=f.sidebar_jquery_obj.height();f.sidebar_bottom=f.sidebar_top+f.sidebar_height;if(f.content_height<=f.sidebar_height)f.sidebar_state="case_6_content_too_small";else if(f.sidebar_height<e){var n=f.content_top;tdAffix.is_menu_affix||"undefined"===typeof window.tdThemeName||"Newsmag"!==window.tdThemeName||"smart_snap_always"!==tdAffix.tds_snap_menu||(n+=b);tdSmartSidebar._is_smaller_or_equal(a,n)?f.sidebar_state=
...
a)?f.sidebar_state="case_4_fixed_up":"up"===d&&!0===tdSmartSidebar._is_smaller_or_equal(g,f.sidebar_top)&&(f.sidebar_state="case_2_top_of_content"),"case_1_fixed_down"===f.sidebar_state&&"up"===d||"case_4_fixed_up"===f.sidebar_state&&"down"===d)f.sidebar_state="case_5_absolute";var n=0,w=tdViewport.getCurrentIntervalItem();null!==w&&(n=w.sidebarWidth);switch(f.sidebar_state){case "case_1_fixed_down":if(!0===f.case_1_run_once)break;tdSmartSidebar.log("sidebar_id: "+l+" "+f.sidebar_state);f.case_1_run_once=
!0;f.case_2_run_once=!1;f.case_3_run_once=!1;f.case_4_run_once=!1;f.case_5_run_once=!1;f.case_6_run_once=!1;f.sidebar_jquery_obj.css({width:n,position:"fixed",top:"auto",bottom:"0","z-index":"1"});break;case "case_2_top_of_content":if(!0===f.case_2_run_once)break;tdSmartSidebar.log("sidebar_id: "+l+" "+f.sidebar_state);f.case_1_run_once=!1;f.case_2_run_once=!0;f.case_3_run_once=!1;f.case_4_run_once=!1;f.case_5_run_once=!1;f.case_6_run_once=!1;f.sidebar_jquery_obj.css({width:"auto",position:"static",
top:"auto",bottom:"auto"});break;case "case_3_bottom_of_content":if(!0===f.case_3_run_once&&f.case_3_last_sidebar_height===f.sidebar_height&&f.case_3_last_content_height===f.content_height)break;tdSmartSidebar.log("sidebar_id: "+l+" "+f.sidebar_state);f.case_1_run_once=!1;f.case_2_run_once=!1;f.case_3_run_once=!0;f.case_3_last_sidebar_height=f.sidebar_height;f.case_3_last_content_height=f.content_height;f.case_4_run_once=!1;f.case_5_run_once=!1;f.case_6_run_once=!1;f.sidebar_jquery_obj.css({width:n,
position:"absolute",top:f.content_bottom-f.sidebar_height-f.content_top,bottom:"auto"});break;case "case_4_fixed_up":if(!0===f.case_4_run_once&&f.case_4_last_menu_offset===b)break;tdSmartSidebar.log("sidebar_id: "+l+" "+f.sidebar_state);f.case_1_run_once=!1;f.case_2_run_once=!1;f.case_3_run_once=!1;f.case_4_run_once=!0;f.case_4_last_menu_offset=b;f.case_5_run_once=!1;f.case_6_run_once=!1;f.sidebar_jquery_obj.css({width:n,position:"fixed",top:b,bottom:"auto"});break;case "case_5_absolute":if(!0===
f.case_5_run_once)break;tdSmartSidebar.log("sidebar_id: "+l+" "+f.sidebar_state);f.case_1_run_once=!1;f.case_2_run_once=!1;f.case_3_run_once=!1;f.case_4_run_once=!1;f.case_5_run_once=!0;f.case_6_run_once=!1;f.sidebar_jquery_obj.css({width:n,position:"absolute",top:f.sidebar_top-f.content_top,bottom:"auto"});break;case "case_6_content_too_small":!0!==f.case_6_run_once&&(tdSmartSidebar.log("sidebar_id: "+l+" "+f.sidebar_state),f.case_1_run_once=!1,f.case_2_run_once=!1,f.case_3_run_once=!1,f.case_4_run_once=
...
var Froogaloop=function(){function a(b){return new a.fn.init(b)}function b(a,b,c){if(!c.contentWindow.postMessage)return!1;var d=c.getAttribute("src").split("?")[0];a=JSON.stringify({method:a,value:b});"//"===d.substr(0,2)&&(d=window.location.protocol+d);c.contentWindow.postMessage(a,d)}function c(a){var b,c;try{b=JSON.parse(a.data),c=b.event||b.method}catch(u){}"ready"==c&&!g&&(g=!0);if(a.origin!=l)return!1;a=b.value;var d=b.data,f=""===f?null:b.player_id;b=f?e[f][c]:e[c];c=[];if(!b)return!1;void 0!==
a&&c.push(a);d&&c.push(d);f&&c.push(f);return 0<c.length?b.apply(null,c):b.call()}function d(a,b,c){c?(e[c]||(e[c]={}),e[c][a]=b):e[a]=b}var e={},g=!1,l="";a.fn=a.prototype={element:null,init:function(a){"string"===typeof a&&(a=document.getElementById(a));this.element=a;a=this.element.getAttribute("src");"//"===a.substr(0,2)&&(a=window.location.protocol+a);a=a.split("/");for(var b="",c=0,d=a.length;c<d;c++){if(3>c)b+=a[c];else break;2>c&&(b+="/")}l=b;return this},api:function(a,c){if(!this.element||
!a)return!1;var e=this.element,f=""!==e.id?e.id:null,g=c&&c.constructor&&c.call&&c.apply?null:c,l=c&&c.constructor&&c.call&&c.apply?c:null;l&&d(a,l,f);b(a,g,e);return this},addEvent:function(a,c){if(!this.element)return!1;var e=this.element,f=""!==e.id?e.id:null;d(a,c,f);"ready"!=a?b("addEventListener",a,e):"ready"==a&&g&&c.call(null,f);return this},removeEvent:function(a){if(!this.element)return!1;var c=this.element,d;a:{if((d=""!==c.id?c.id:null)&&e[d]){if(!e[d][a]){d=!1;break a}e[d][a]=null}else{if(!e[a]){d=
!1;break a}e[a]=null}d=!0}"ready"!=a&&d&&b("removeEventListener",a,c)}};a.fn.init.prototype=a.fn;window.addEventListener?window.addEventListener("message",c,!1):window.attachEvent("onmessage",c);return window.Froogaloop=window.$f=a}(),tdCustomEvents={};
(function(){tdCustomEvents={_callback_scroll:function(){tdAnimationScroll.compute_all_items()},_callback_resize:function(){},_lazy_callback_scroll_100:function(){!0===tdAnimationStack.activated&&tdAnimationStack.td_events_scroll()},_lazy_callback_scroll_500:function(){},_lazy_callback_resize_100:function(){tdBackstr.td_events_resize();tdAnimationScroll.td_events_resize()},_lazy_callback_resize_500:function(){!0===tdAnimationStack.activated&&tdAnimationStack.td_events_resize();for(var a=0;a<td_backstretch_items.length;a++)tdAnimationScroll.reinitialize_item(td_backstretch_items[a],
!0),td_compute_backstretch_item(td_backstretch_items[a]);tdAnimationScroll.compute_all_items();setMenuMinHeight()}}})();var tdEvents={};
...
(function(){tdYoutubePlayers={tdPlayerContainer:"player_youtube",players:[],init:function(){for(var a=jQuery(".td_wrapper_playlist_player_youtube"),b=0;b<a.length;b++){var c=jQuery(a[b]),d=tdYoutubePlayers.addPlayer(c),e=d.tdPlayerContainer;c.parent().find(".td_youtube_control").data("player-id",e);for(var g=c.parent().find(".td_click_video_youtube"),l=0;l<g.length;l++)jQuery(g[l]).data("player-id",e),l+1<g.length?jQuery(g[l]).data("next-video-id",jQuery(g[l+1]).data("video-id")):jQuery(g[l]).data("next-video-id",
...
tdAnimationStack._initialize_item(c);d.push(c)});(function(){for(var a=!0,l=0;l<d.length;l++)if(!1===e[l].complete){a=!1;break}if(!1===a){var f=(new Date).getTime();tdAnimationStack.log("TIMER - started");var n=setInterval(function(){var g;if((new Date).getTime()-f>tdAnimationStack.max_waiting_for_init)for(clearInterval(n),g=0;g<d.length;g++)d[g].jqueryObj.removeClass(tdAnimationStack._animation_css_class1),d[g].jqueryObj.addClass(tdAnimationStack._animation_css_class2);else{a=!0;for(g=0;g<d.length;g++)if(!1===
e[g].complete){a=!1;break}!0===a&&(clearInterval(n),tdAnimationStack.log("TIMER - stopped"),tdAnimationStack._precompute_items(d,b,c),tdAnimationStack.compute_items())}},100)}else tdAnimationStack._precompute_items(d,b,c),tdAnimationStack.compute_items()})();tdAnimationStack.log("checked for new items finished")}},_precompute_items:function(a,b,c){a.sort(b);if(!0===c)for(;0<a.length;)tdAnimationStack.log("add item 1 : "+a.length),tdAnimationStack._items_in_view_port.push(a.shift());else for(;0<a.length;)tdAnimationStack.log("add item 2 : "+
...
function td_date_i18n(a,b){var c,d,e=/\\?(.?)/gi,g=function(a,b){return d[a]?d[a]():b},l=function(a,b){for(a=String(a);a.length<b;)a="0"+a;return a};d={d:function(){return l(d.j(),2)},D:function(){return tdDateNamesI18n.day_names_short[d.w()]},j:function(){return c.getDate()},l:function(){return tdDateNamesI18n.day_names[d.w()]},N:function(){return d.w()||7},S:function(){var a=d.j(),b=a%10;3>=b&&1==parseInt(a%100/10,10)&&(b=0);return["st","nd","rd"][b-1]||"th"},w:function(){return c.getDay()},z:function(){var a=
