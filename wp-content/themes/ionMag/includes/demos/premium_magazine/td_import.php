...
td_demo_misc::add_ad_image('custom_ad_1', 'td_premium_post_ad');
td_demo_misc::add_ad_image('custom_ad_2', 'td_premium_sidebar_big_ad');
td_demo_misc::add_ad_image('sidebar', 'td_premium_sidebar_ad');
...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => td_global::$get_template_directory . '/includes/demos/premium_magazine/pages/homepage.txt',
    'template' => 'page-pagebuilder-latest.php',   // the page template full file name with .php
    'td_layout' => 'td_module_rd_13',
    'homepage' => true
));
...
td_demo_content::add_post(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/premium_magazine/pages/post_default.txt',
