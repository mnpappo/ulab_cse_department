...
td_demo_misc::add_ad_image('sidebar', 'td_blog_voyage_sidebar_ad');
...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => td_global::$get_template_directory . '/includes/demos/voyage/pages/homepage.txt',
    'template' => 'page-pagebuilder-latest.php',   // the page template full file name with .php
    'td_layout' => 'td_module_rd_7',
    'homepage' => true,
    'limit' => '5'
));
...
td_demo_content::add_post(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/voyage/pages/post_default.txt',
